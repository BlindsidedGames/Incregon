...
namespace World.TileStateMachine.BotControllerStates
{
    public class BotControllerTitaniumState : BotControllerBaseState
    {
        ...
        public override void EnterState(TileBotControllerState botController)
        {
            ...
            if (!oracle.saveData.ownedResources.ContainsKey(Resources.Titanium))
                oracle.saveData.ownedResources.Add(Resources.Titanium, new Resource());
            resource = oracle.saveData.ownedResources[Resources.Titanium];
